...
def parse_arguments():
    ...
    parser.add_argument("--data", type=str, default='/media/robot/hdd/waymo_dataset/tf_example/training',
                        help="Path to raw data")
    parser.add_argument("--out", type=str, default="./prerendered/", help="Path to save data")
    parser.add_argument(
...
def merge(
    ...
    raster_data = rasterize(
        ...
        parsed["scenario/id"].numpy()[0].decode("utf-8").by,
        validate=validate,
    )
