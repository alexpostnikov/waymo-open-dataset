...
class MatrixShape :
 ...
 public:
  ...
  inline void Swap(MatrixShape* other) {
...
class MatrixFloat :
 ...
 public:
  ...
  inline void Swap(MatrixFloat* other) {
    if (other == this) return;
    InternalSwap(other);
  }
...
class CameraName :
 ...
 public:
  ...
  inline void Swap(CameraName* other) {
    if (other == this) return;
    InternalSwap(other);
  }
...
class LaserName :
 ...
 public:
  ...
  inline void Swap(LaserName* other) {
    if (other == this) return;
    InternalSwap(other);
  }
...
class CameraCalibration :
 ...
 public:
  ...
  enum : int {
    ...
    kExtrinsicFieldNumber = 3,
    kNameFieldNumber = 1,
    kWidthFieldNumber = 4,
    kHeightFieldNumber = 5,
    kRollingShutterDirectionFieldNumber = 6,
  };
...
class LaserCalibration :
 ...
 public:
  ...
  inline void Swap(LaserCalibration* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  enum : int {
    kBeamInclinationsFieldNumber = 2,
    kExtrinsicFieldNumber = 5,
    kBeamInclinationMinFieldNumber = 3,
    kBeamInclinationMaxFieldNumber = 4,
    kNameFieldNumber = 1,
  };
...
class Context_Stats_ObjectCount :
 ...
 public:
  ...
  inline void Swap(Context_Stats_ObjectCount* other) {
    if (other == this) return;
    InternalSwap(other);
  }
...
class Context_Stats :
 ...
 public:
  ...
  inline void Swap(Context_Stats* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  enum : int {
    kLaserObjectCountsFieldNumber = 1,
    kCameraObjectCountsFieldNumber = 5,
...
class Context :
 ...
 public:
  ...
  enum : int {
    kCameraCalibrationsFieldNumber = 2,
    kLaserCalibrationsFieldNumber = 3,
    kNameFieldNumber = 1,
    kStatsFieldNumber = 4,
  };
...
class RangeImage :
 ...
 public:
  ...
  inline void Swap(RangeImage* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  enum : int {
    kRangeImageCompressedFieldNumber = 2,
    kCameraProjectionCompressedFieldNumber = 3,
    kRangeImagePoseCompressedFieldNumber = 4,
    kRangeImageFlowCompressedFieldNumber = 5,
    kSegmentationLabelCompressedFieldNumber = 6,
    kRangeImageFieldNumber = 1,
  };
  ...
  bool has_range_image_flow_compressed() const;
  void clear_range_image_flow_compressed();
  const std::string& range_image_flow_compressed() const;
  void set_range_image_flow_compressed(const std::string& value);
  void set_range_image_flow_compressed(std::string&& value);
  void set_range_image_flow_compressed(const char* value);
  void set_range_image_flow_compressed(const void* value, size_t size);
  std::string* mutable_range_image_flow_compressed();
  std::string* release_range_image_flow_compressed();
  void set_allocated_range_image_flow_compressed(std::string* range_image_flow_compressed);

  // optional bytes segmentation_label_compressed = 6;
  bool has_segmentation_label_compressed() const;
  void clear_segmentation_label_compressed();
  const std::string& segmentation_label_compressed() const;
  void set_segmentation_label_compressed(const std::string& value);
  void set_segmentation_label_compressed(std::string&& value);
  void set_segmentation_label_compressed(const char* value);
  void set_segmentation_label_compressed(const void* value, size_t size);
  std::string* mutable_segmentation_label_compressed();
  std::string* release_segmentation_label_compressed();
  void set_allocated_segmentation_label_compressed(std::string* segmentation_label_compressed);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr range_image_flow_compressed_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr segmentation_label_compressed_;
...
class CameraImage :
 ...
 public:
  ...
  enum : int {
    ...
    kPoseTimestampFieldNumber = 5,
    kShutterFieldNumber = 6,
    kCameraTriggerTimeFieldNumber = 7,
    kCameraReadoutDoneTimeFieldNumber = 8,
    kNameFieldNumber = 1,
  };
...
class CameraLabels :
 ...
 public:
  ...
  inline void Swap(CameraLabels* other) {
    if (other == this) return;
    InternalSwap(other);
  }
...
class Laser :
 ...
 public:
  ...
  enum : int {
    kRiReturn1FieldNumber = 2,
    kRiReturn2FieldNumber = 3,
    kNameFieldNumber = 1,
  };
...
class Frame :
 ...
 public:
  ...
  enum : int {
    ...
    kLasersFieldNumber = 5,
    kLaserLabelsFieldNumber = 6,
    kNoLabelZonesFieldNumber = 7,
    kCameraLabelsFieldNumber = 8,
    kProjectedLidarLabelsFieldNumber = 9,
    kContextFieldNumber = 1,
    kPoseFieldNumber = 3,
    kTimestampMicrosFieldNumber = 2,
  };
...
// optional bytes range_image_flow_compressed = 5;
inline bool RangeImage::has_range_image_flow_compressed() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void RangeImage::clear_range_image_flow_compressed() {
  range_image_flow_compressed_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000008u;
}
inline const std::string& RangeImage::range_image_flow_compressed() const {
  // @@protoc_insertion_point(field_get:waymo.open_dataset.RangeImage.range_image_flow_compressed)
  return range_image_flow_compressed_.GetNoArena();
}
inline void RangeImage::set_range_image_flow_compressed(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  range_image_flow_compressed_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:waymo.open_dataset.RangeImage.range_image_flow_compressed)
}
inline void RangeImage::set_range_image_flow_compressed(std::string&& value) {
  _has_bits_[0] |= 0x00000008u;
  range_image_flow_compressed_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:waymo.open_dataset.RangeImage.range_image_flow_compressed)
}
inline void RangeImage::set_range_image_flow_compressed(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000008u;
  range_image_flow_compressed_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:waymo.open_dataset.RangeImage.range_image_flow_compressed)
}
inline void RangeImage::set_range_image_flow_compressed(const void* value, size_t size) {
  _has_bits_[0] |= 0x00000008u;
  range_image_flow_compressed_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:waymo.open_dataset.RangeImage.range_image_flow_compressed)
}
inline std::string* RangeImage::mutable_range_image_flow_compressed() {
  _has_bits_[0] |= 0x00000008u;
  // @@protoc_insertion_point(field_mutable:waymo.open_dataset.RangeImage.range_image_flow_compressed)
  return range_image_flow_compressed_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RangeImage::release_range_image_flow_compressed() {
  // @@protoc_insertion_point(field_release:waymo.open_dataset.RangeImage.range_image_flow_compressed)
  if (!has_range_image_flow_compressed()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000008u;
  return range_image_flow_compressed_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RangeImage::set_allocated_range_image_flow_compressed(std::string* range_image_flow_compressed) {
  if (range_image_flow_compressed != nullptr) {
    _has_bits_[0] |= 0x00000008u;
  } else {
    _has_bits_[0] &= ~0x00000008u;
  }
  range_image_flow_compressed_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), range_image_flow_compressed);
  // @@protoc_insertion_point(field_set_allocated:waymo.open_dataset.RangeImage.range_image_flow_compressed)
}

// optional bytes segmentation_label_compressed = 6;
inline bool RangeImage::has_segmentation_label_compressed() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void RangeImage::clear_segmentation_label_compressed() {
  segmentation_label_compressed_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000010u;
}
inline const std::string& RangeImage::segmentation_label_compressed() const {
  // @@protoc_insertion_point(field_get:waymo.open_dataset.RangeImage.segmentation_label_compressed)
  return segmentation_label_compressed_.GetNoArena();
}
inline void RangeImage::set_segmentation_label_compressed(const std::string& value) {
  _has_bits_[0] |= 0x00000010u;
  segmentation_label_compressed_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:waymo.open_dataset.RangeImage.segmentation_label_compressed)
}
inline void RangeImage::set_segmentation_label_compressed(std::string&& value) {
  _has_bits_[0] |= 0x00000010u;
  segmentation_label_compressed_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:waymo.open_dataset.RangeImage.segmentation_label_compressed)
}
inline void RangeImage::set_segmentation_label_compressed(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000010u;
  segmentation_label_compressed_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:waymo.open_dataset.RangeImage.segmentation_label_compressed)
}
inline void RangeImage::set_segmentation_label_compressed(const void* value, size_t size) {
  _has_bits_[0] |= 0x00000010u;
  segmentation_label_compressed_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:waymo.open_dataset.RangeImage.segmentation_label_compressed)
}
inline std::string* RangeImage::mutable_segmentation_label_compressed() {
  _has_bits_[0] |= 0x00000010u;
  // @@protoc_insertion_point(field_mutable:waymo.open_dataset.RangeImage.segmentation_label_compressed)
  return segmentation_label_compressed_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RangeImage::release_segmentation_label_compressed() {
  // @@protoc_insertion_point(field_release:waymo.open_dataset.RangeImage.segmentation_label_compressed)
  if (!has_segmentation_label_compressed()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000010u;
  return segmentation_label_compressed_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RangeImage::set_allocated_segmentation_label_compressed(std::string* segmentation_label_compressed) {
  if (segmentation_label_compressed != nullptr) {
    _has_bits_[0] |= 0x00000010u;
  } else {
    _has_bits_[0] &= ~0x00000010u;
  }
  segmentation_label_compressed_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), segmentation_label_compressed);
  // @@protoc_insertion_point(field_set_allocated:waymo.open_dataset.RangeImage.segmentation_label_compressed)
}
