...
class DetectionMeasurement_Details;
class DetectionMeasurement_DetailsDefaultTypeInternal;
extern DetectionMeasurement_DetailsDefaultTypeInternal _DetectionMeasurement_Details_default_instance_;
...
template<> ::waymo::open_dataset::DetectionMeasurement_Details* Arena::CreateMaybeMessage<::waymo::open_dataset::DetectionMeasurement_Details>(Arena*);
...
class Object :
 ...
 public:
  ...
  enum : int {
    kContextNameFieldNumber = 4,
    kObjectFieldNumber = 1,
    kOverlapWithNlzFieldNumber = 3,
    kCameraNameFieldNumber = 6,
    kFrameTimestampMicrosFieldNumber = 5,
    kScoreFieldNumber = 2,
  };
...
class NoLabelZoneObject :
 ...
 public:
  ...
  inline void Swap(NoLabelZoneObject* other) {
    if (other == this) return;
    InternalSwap(other);
  }
...
class Objects :
 ...
 public:
  ...
  enum : int {
    ...
    kNoLabelZoneObjectsFieldNumber = 2,
  };
...
class MatcherProto :
 ...
 public:
  ...
  inline void Swap(MatcherProto* other) {
    if (other == this) return;
    InternalSwap(other);
  }
...
class Difficulty :
 ...
 public:
  ...
  inline void Swap(Difficulty* other) {
    if (other == this) return;
    InternalSwap(other);
  }
...
class Config :
 ...
 public:
  ...
  enum : int {
    kScoreCutoffsFieldNumber = 1,
    kBreakdownGeneratorIdsFieldNumber = 3,
    kDifficultiesFieldNumber = 4,
    kIouThresholdsFieldNumber = 6,
    kNumDesiredScoreCutoffsFieldNumber = 2,
    kMatcherTypeFieldNumber = 5,
    kBoxTypeFieldNumber = 7,
    kMinPrecisionFieldNumber = 9,
    kIncludeDetailsInMeasurementsFieldNumber = 11,
    kDesiredRecallDeltaFieldNumber = 8,
    kMinHeadingAccuracyFieldNumber = 10,
  };
  ...
  bool has_include_details_in_measurements() const;
  void clear_include_details_in_measurements();
  bool include_details_in_measurements() const;
  void set_include_details_in_measurements(bool value);
 ...
 private:
  ...
  bool include_details_in_measurements_;
...
class DetectionMeasurement_Details :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:waymo.open_dataset.DetectionMeasurement.Details) */ {
 public:
  DetectionMeasurement_Details();
  virtual ~DetectionMeasurement_Details();

  DetectionMeasurement_Details(const DetectionMeasurement_Details& from);
  DetectionMeasurement_Details(DetectionMeasurement_Details&& from) noexcept
    : DetectionMeasurement_Details() {
    *this = ::std::move(from);
  }

  inline DetectionMeasurement_Details& operator=(const DetectionMeasurement_Details& from) {
    CopyFrom(from);
    return *this;
  }
  inline DetectionMeasurement_Details& operator=(DetectionMeasurement_Details&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const DetectionMeasurement_Details& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const DetectionMeasurement_Details* internal_default_instance() {
    return reinterpret_cast<const DetectionMeasurement_Details*>(
               &_DetectionMeasurement_Details_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  friend void swap(DetectionMeasurement_Details& a, DetectionMeasurement_Details& b) {
    a.Swap(&b);
  }
  inline void Swap(DetectionMeasurement_Details* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline DetectionMeasurement_Details* New() const final {
    return CreateMaybeMessage<DetectionMeasurement_Details>(nullptr);
  }

  DetectionMeasurement_Details* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DetectionMeasurement_Details>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const DetectionMeasurement_Details& from);
  void MergeFrom(const DetectionMeasurement_Details& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DetectionMeasurement_Details* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "waymo.open_dataset.DetectionMeasurement.Details";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  enum : int {
    kFpIdsFieldNumber = 1,
    kFnIdsFieldNumber = 2,
    kTpGtIdsFieldNumber = 3,
    kTpPrIdsFieldNumber = 4,
  };
  // repeated string fp_ids = 1;
  int fp_ids_size() const;
  void clear_fp_ids();
  const std::string& fp_ids(int index) const;
  std::string* mutable_fp_ids(int index);
  void set_fp_ids(int index, const std::string& value);
  void set_fp_ids(int index, std::string&& value);
  void set_fp_ids(int index, const char* value);
  void set_fp_ids(int index, const char* value, size_t size);
  std::string* add_fp_ids();
  void add_fp_ids(const std::string& value);
  void add_fp_ids(std::string&& value);
  void add_fp_ids(const char* value);
  void add_fp_ids(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& fp_ids() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_fp_ids();

  // repeated string fn_ids = 2;
  int fn_ids_size() const;
  void clear_fn_ids();
  const std::string& fn_ids(int index) const;
  std::string* mutable_fn_ids(int index);
  void set_fn_ids(int index, const std::string& value);
  void set_fn_ids(int index, std::string&& value);
  void set_fn_ids(int index, const char* value);
  void set_fn_ids(int index, const char* value, size_t size);
  std::string* add_fn_ids();
  void add_fn_ids(const std::string& value);
  void add_fn_ids(std::string&& value);
  void add_fn_ids(const char* value);
  void add_fn_ids(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& fn_ids() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_fn_ids();

  // repeated string tp_gt_ids = 3;
  int tp_gt_ids_size() const;
  void clear_tp_gt_ids();
  const std::string& tp_gt_ids(int index) const;
  std::string* mutable_tp_gt_ids(int index);
  void set_tp_gt_ids(int index, const std::string& value);
  void set_tp_gt_ids(int index, std::string&& value);
  void set_tp_gt_ids(int index, const char* value);
  void set_tp_gt_ids(int index, const char* value, size_t size);
  std::string* add_tp_gt_ids();
  void add_tp_gt_ids(const std::string& value);
  void add_tp_gt_ids(std::string&& value);
  void add_tp_gt_ids(const char* value);
  void add_tp_gt_ids(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& tp_gt_ids() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_tp_gt_ids();

  // repeated string tp_pr_ids = 4;
  int tp_pr_ids_size() const;
  void clear_tp_pr_ids();
  const std::string& tp_pr_ids(int index) const;
  std::string* mutable_tp_pr_ids(int index);
  void set_tp_pr_ids(int index, const std::string& value);
  void set_tp_pr_ids(int index, std::string&& value);
  void set_tp_pr_ids(int index, const char* value);
  void set_tp_pr_ids(int index, const char* value, size_t size);
  std::string* add_tp_pr_ids();
  void add_tp_pr_ids(const std::string& value);
  void add_tp_pr_ids(std::string&& value);
  void add_tp_pr_ids(const char* value);
  void add_tp_pr_ids(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& tp_pr_ids() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_tp_pr_ids();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> fp_ids_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> fn_ids_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> tp_gt_ids_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> tp_pr_ids_;
  friend struct ::TableStruct_waymo_5fopen_5fdataset_2fprotos_2fmetrics_2eproto;
};
// -------------------------------------------------------------------
...
class DetectionMeasurement :
 ...
 public:
  ...
  typedef DetectionMeasurement_Details Details;

  // accessors -------------------------------------------------------

  enum : int {
    kDetailsFieldNumber = 6,
    kNumFpsFieldNumber = 1,
    kNumTpsFieldNumber = 2,
    kNumFnsFieldNumber = 3,
    kSumHaFieldNumber = 4,
    kScoreCutoffFieldNumber = 5,
  };
  // repeated .waymo.open_dataset.DetectionMeasurement.Details details = 6;
  int details_size() const;
  void clear_details();
  ::waymo::open_dataset::DetectionMeasurement_Details* mutable_details(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::waymo::open_dataset::DetectionMeasurement_Details >*
      mutable_details();
  const ::waymo::open_dataset::DetectionMeasurement_Details& details(int index) const;
  ::waymo::open_dataset::DetectionMeasurement_Details* add_details();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::waymo::open_dataset::DetectionMeasurement_Details >&
      details() const;
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::waymo::open_dataset::DetectionMeasurement_Details > details_;
...
class DetectionMeasurements :
 ...
 public:
  ...
  inline void Swap(DetectionMeasurements* other) {
    if (other == this) return;
    InternalSwap(other);
  }
...
class DetectionMetrics :
 ...
 public:
  ...
  inline void Swap(DetectionMetrics* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  enum : int {
    kPrecisionsFieldNumber = 3,
    kRecallsFieldNumber = 4,
    kPrecisionsHaWeightedFieldNumber = 5,
    kRecallsHaWeightedFieldNumber = 6,
    kScoreCutoffsFieldNumber = 7,
    kBreakdownFieldNumber = 8,
    kMeasurementsFieldNumber = 9,
    kMeanAveragePrecisionFieldNumber = 1,
    kMeanAveragePrecisionHaWeightedFieldNumber = 2,
  };
...
class TrackingMeasurement :
 ...
 public:
  ...
  inline void Swap(TrackingMeasurement* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  enum : int {
    kNumMissesFieldNumber = 1,
    kNumFpsFieldNumber = 2,
    kMatchingCostFieldNumber = 4,
    kNumMismatchesFieldNumber = 3,
    kNumMatchesFieldNumber = 5,
    kNumObjectsGtFieldNumber = 6,
    kScoreCutoffFieldNumber = 7,
  };
...
class TrackingMeasurements :
 ...
 public:
  ...
  inline void Swap(TrackingMeasurements* other) {
    if (other == this) return;
    InternalSwap(other);
  }
...
class TrackingMetrics :
 ...
 public:
  ...
  inline void Swap(TrackingMetrics* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  enum : int {
    kBreakdownFieldNumber = 7,
    kMeasurementsFieldNumber = 8,
    kMotaFieldNumber = 1,
    kMotpFieldNumber = 2,
    kMissFieldNumber = 3,
    kMismatchFieldNumber = 4,
    kFpFieldNumber = 5,
    kScoreCutoffFieldNumber = 6,
  };
...
// optional bool include_details_in_measurements = 11;
inline bool Config::has_include_details_in_measurements() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void Config::clear_include_details_in_measurements() {
  include_details_in_measurements_ = false;
  _has_bits_[0] &= ~0x00000010u;
}
inline bool Config::include_details_in_measurements() const {
  // @@protoc_insertion_point(field_get:waymo.open_dataset.Config.include_details_in_measurements)
  return include_details_in_measurements_;
}
inline void Config::set_include_details_in_measurements(bool value) {
  _has_bits_[0] |= 0x00000010u;
  include_details_in_measurements_ = value;
  // @@protoc_insertion_point(field_set:waymo.open_dataset.Config.include_details_in_measurements)
}
...
// repeated string fp_ids = 1;
inline int DetectionMeasurement_Details::fp_ids_size() const {
  return fp_ids_.size();
}
inline void DetectionMeasurement_Details::clear_fp_ids() {
  fp_ids_.Clear();
}
inline const std::string& DetectionMeasurement_Details::fp_ids(int index) const {
  // @@protoc_insertion_point(field_get:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
  return fp_ids_.Get(index);
}
inline std::string* DetectionMeasurement_Details::mutable_fp_ids(int index) {
  // @@protoc_insertion_point(field_mutable:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
  return fp_ids_.Mutable(index);
}
inline void DetectionMeasurement_Details::set_fp_ids(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
  fp_ids_.Mutable(index)->assign(value);
}
inline void DetectionMeasurement_Details::set_fp_ids(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
  fp_ids_.Mutable(index)->assign(std::move(value));
}
inline void DetectionMeasurement_Details::set_fp_ids(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  fp_ids_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
}
inline void DetectionMeasurement_Details::set_fp_ids(int index, const char* value, size_t size) {
  fp_ids_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
}
inline std::string* DetectionMeasurement_Details::add_fp_ids() {
  // @@protoc_insertion_point(field_add_mutable:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
  return fp_ids_.Add();
}
inline void DetectionMeasurement_Details::add_fp_ids(const std::string& value) {
  fp_ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
}
inline void DetectionMeasurement_Details::add_fp_ids(std::string&& value) {
  fp_ids_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
}
inline void DetectionMeasurement_Details::add_fp_ids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  fp_ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
}
inline void DetectionMeasurement_Details::add_fp_ids(const char* value, size_t size) {
  fp_ids_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
DetectionMeasurement_Details::fp_ids() const {
  // @@protoc_insertion_point(field_list:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
  return fp_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
DetectionMeasurement_Details::mutable_fp_ids() {
  // @@protoc_insertion_point(field_mutable_list:waymo.open_dataset.DetectionMeasurement.Details.fp_ids)
  return &fp_ids_;
}

// repeated string fn_ids = 2;
inline int DetectionMeasurement_Details::fn_ids_size() const {
  return fn_ids_.size();
}
inline void DetectionMeasurement_Details::clear_fn_ids() {
  fn_ids_.Clear();
}
inline const std::string& DetectionMeasurement_Details::fn_ids(int index) const {
  // @@protoc_insertion_point(field_get:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
  return fn_ids_.Get(index);
}
inline std::string* DetectionMeasurement_Details::mutable_fn_ids(int index) {
  // @@protoc_insertion_point(field_mutable:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
  return fn_ids_.Mutable(index);
}
inline void DetectionMeasurement_Details::set_fn_ids(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
  fn_ids_.Mutable(index)->assign(value);
}
inline void DetectionMeasurement_Details::set_fn_ids(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
  fn_ids_.Mutable(index)->assign(std::move(value));
}
inline void DetectionMeasurement_Details::set_fn_ids(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  fn_ids_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
}
inline void DetectionMeasurement_Details::set_fn_ids(int index, const char* value, size_t size) {
  fn_ids_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
}
inline std::string* DetectionMeasurement_Details::add_fn_ids() {
  // @@protoc_insertion_point(field_add_mutable:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
  return fn_ids_.Add();
}
inline void DetectionMeasurement_Details::add_fn_ids(const std::string& value) {
  fn_ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
}
inline void DetectionMeasurement_Details::add_fn_ids(std::string&& value) {
  fn_ids_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
}
inline void DetectionMeasurement_Details::add_fn_ids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  fn_ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
}
inline void DetectionMeasurement_Details::add_fn_ids(const char* value, size_t size) {
  fn_ids_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
DetectionMeasurement_Details::fn_ids() const {
  // @@protoc_insertion_point(field_list:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
  return fn_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
DetectionMeasurement_Details::mutable_fn_ids() {
  // @@protoc_insertion_point(field_mutable_list:waymo.open_dataset.DetectionMeasurement.Details.fn_ids)
  return &fn_ids_;
}

// repeated string tp_gt_ids = 3;
inline int DetectionMeasurement_Details::tp_gt_ids_size() const {
  return tp_gt_ids_.size();
}
inline void DetectionMeasurement_Details::clear_tp_gt_ids() {
  tp_gt_ids_.Clear();
}
inline const std::string& DetectionMeasurement_Details::tp_gt_ids(int index) const {
  // @@protoc_insertion_point(field_get:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
  return tp_gt_ids_.Get(index);
}
inline std::string* DetectionMeasurement_Details::mutable_tp_gt_ids(int index) {
  // @@protoc_insertion_point(field_mutable:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
  return tp_gt_ids_.Mutable(index);
}
inline void DetectionMeasurement_Details::set_tp_gt_ids(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
  tp_gt_ids_.Mutable(index)->assign(value);
}
inline void DetectionMeasurement_Details::set_tp_gt_ids(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
  tp_gt_ids_.Mutable(index)->assign(std::move(value));
}
inline void DetectionMeasurement_Details::set_tp_gt_ids(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  tp_gt_ids_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
}
inline void DetectionMeasurement_Details::set_tp_gt_ids(int index, const char* value, size_t size) {
  tp_gt_ids_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
}
inline std::string* DetectionMeasurement_Details::add_tp_gt_ids() {
  // @@protoc_insertion_point(field_add_mutable:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
  return tp_gt_ids_.Add();
}
inline void DetectionMeasurement_Details::add_tp_gt_ids(const std::string& value) {
  tp_gt_ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
}
inline void DetectionMeasurement_Details::add_tp_gt_ids(std::string&& value) {
  tp_gt_ids_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
}
inline void DetectionMeasurement_Details::add_tp_gt_ids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  tp_gt_ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
}
inline void DetectionMeasurement_Details::add_tp_gt_ids(const char* value, size_t size) {
  tp_gt_ids_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
DetectionMeasurement_Details::tp_gt_ids() const {
  // @@protoc_insertion_point(field_list:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
  return tp_gt_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
DetectionMeasurement_Details::mutable_tp_gt_ids() {
  // @@protoc_insertion_point(field_mutable_list:waymo.open_dataset.DetectionMeasurement.Details.tp_gt_ids)
  return &tp_gt_ids_;
}

// repeated string tp_pr_ids = 4;
inline int DetectionMeasurement_Details::tp_pr_ids_size() const {
  return tp_pr_ids_.size();
}
inline void DetectionMeasurement_Details::clear_tp_pr_ids() {
  tp_pr_ids_.Clear();
}
inline const std::string& DetectionMeasurement_Details::tp_pr_ids(int index) const {
  // @@protoc_insertion_point(field_get:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
  return tp_pr_ids_.Get(index);
}
inline std::string* DetectionMeasurement_Details::mutable_tp_pr_ids(int index) {
  // @@protoc_insertion_point(field_mutable:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
  return tp_pr_ids_.Mutable(index);
}
inline void DetectionMeasurement_Details::set_tp_pr_ids(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
  tp_pr_ids_.Mutable(index)->assign(value);
}
inline void DetectionMeasurement_Details::set_tp_pr_ids(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
  tp_pr_ids_.Mutable(index)->assign(std::move(value));
}
inline void DetectionMeasurement_Details::set_tp_pr_ids(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  tp_pr_ids_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
}
inline void DetectionMeasurement_Details::set_tp_pr_ids(int index, const char* value, size_t size) {
  tp_pr_ids_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
}
inline std::string* DetectionMeasurement_Details::add_tp_pr_ids() {
  // @@protoc_insertion_point(field_add_mutable:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
  return tp_pr_ids_.Add();
}
inline void DetectionMeasurement_Details::add_tp_pr_ids(const std::string& value) {
  tp_pr_ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
}
inline void DetectionMeasurement_Details::add_tp_pr_ids(std::string&& value) {
  tp_pr_ids_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
}
inline void DetectionMeasurement_Details::add_tp_pr_ids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  tp_pr_ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
}
inline void DetectionMeasurement_Details::add_tp_pr_ids(const char* value, size_t size) {
  tp_pr_ids_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
DetectionMeasurement_Details::tp_pr_ids() const {
  // @@protoc_insertion_point(field_list:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
  return tp_pr_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
DetectionMeasurement_Details::mutable_tp_pr_ids() {
  // @@protoc_insertion_point(field_mutable_list:waymo.open_dataset.DetectionMeasurement.Details.tp_pr_ids)
  return &tp_pr_ids_;
}
...
// repeated .waymo.open_dataset.DetectionMeasurement.Details details = 6;
inline int DetectionMeasurement::details_size() const {
  return details_.size();
}
inline void DetectionMeasurement::clear_details() {
  details_.Clear();
}
inline ::waymo::open_dataset::DetectionMeasurement_Details* DetectionMeasurement::mutable_details(int index) {
  // @@protoc_insertion_point(field_mutable:waymo.open_dataset.DetectionMeasurement.details)
  return details_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::waymo::open_dataset::DetectionMeasurement_Details >*
DetectionMeasurement::mutable_details() {
  // @@protoc_insertion_point(field_mutable_list:waymo.open_dataset.DetectionMeasurement.details)
  return &details_;
}
inline const ::waymo::open_dataset::DetectionMeasurement_Details& DetectionMeasurement::details(int index) const {
  // @@protoc_insertion_point(field_get:waymo.open_dataset.DetectionMeasurement.details)
  return details_.Get(index);
}
inline ::waymo::open_dataset::DetectionMeasurement_Details* DetectionMeasurement::add_details() {
  // @@protoc_insertion_point(field_add:waymo.open_dataset.DetectionMeasurement.details)
  return details_.Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::waymo::open_dataset::DetectionMeasurement_Details >&
DetectionMeasurement::details() const {
  // @@protoc_insertion_point(field_list:waymo.open_dataset.DetectionMeasurement.details)
  return details_;
}
