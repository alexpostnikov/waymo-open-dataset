...
constexpr Breakdown_GeneratorId Breakdown_GeneratorId_GeneratorId_MAX = Breakdown_GeneratorId_SIZE;
...
class Breakdown :
 ...
 public:
  ...
  static constexpr GeneratorId SIZE =
    Breakdown_GeneratorId_SIZE;
