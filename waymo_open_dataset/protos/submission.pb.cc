...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_waymo_5fopen_5fdataset_2fprotos_2fsubmission_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::waymo::open_dataset::Submission, docker_image_source_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 19, sizeof(::waymo::open_dataset::Submission)},
};
...
const char descriptor_table_protodef_waymo_5fopen_5fdataset_2fprotos_2fsubmission_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "od_link\030\006 \001(\t\022\033\n\023docker_image_source\030\020 \001"
  "(\t\022>\n\013sensor_type\030\014 \001(\0162).waymo.open_dat"
  "aset.Submission.SensorType\022*\n\"number_pas"
  "t_frames_exclude_current\030\t \001(\005\022,\n$number"
  "_future_frames_exclude_current\030\n \001(\005\0226\n\021"
  "inference_results\030\013 \001(\0132\033.waymo.open_dat"
  "aset.Objects\0224\n\014object_types\030\016 \003(\0162\036.way"
  "mo.open_dataset.Label.Type\022\026\n\016latency_se"
  "cond\030\017 \001(\002\"p\n\004Task\022\013\n\007UNKNOWN\020\000\022\020\n\014DETEC"
  "TION_2D\020\001\022\020\n\014DETECTION_3D\020\002\022\017\n\013TRACKING_"
  "2D\020\003\022\017\n\013TRACKING_3D\020\004\022\025\n\021DOMAIN_ADAPTATI"
  "ON\020\005\"s\n\nSensorType\022\013\n\007INVALID\020\000\022\r\n\tLIDAR"
  "_ALL\020\001\022\r\n\tLIDAR_TOP\020\002\022\016\n\nCAMERA_ALL\020\003\022\024\n"
  "\020CAMERA_LIDAR_TOP\020\004\022\024\n\020CAMERA_LIDAR_ALL\020"
  "\005J\004\010\007\020\010J\004\010\010\020\t"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_waymo_5fopen_5fdataset_2fprotos_2fsubmission_2eproto = {
  &descriptor_table_waymo_5fopen_5fdataset_2fprotos_2fsubmission_2eproto_initialized, descriptor_table_protodef_waymo_5fopen_5fdataset_2fprotos_2fsubmission_2eproto, "waymo_open_dataset/protos/submission.proto", 893,
...
class Submission::_Internal {
 public:
  ...
  static void set_has_docker_image_source(HasBits* has_bits) {
    (*has_bits)[0] |= 32u;
  }
...
Submission::_Internal::inference_results(const Submission* msg) {
...
Submission::Submission(const Submission& from)
  ...
  docker_image_source_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from.has_docker_image_source()) {
    docker_image_source_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.docker_image_source_);
  }
...
void Submission::SharedDtor() {
  ...
  docker_image_source_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
// @@protoc_insertion_point(message_clear_start:waymo.open_dataset.Submission)
  ...
  if (cached_has_bits & 0x0000007fu) {
    ...
    if (cached_has_bits & 0x00000020u) {
      docker_image_source_.ClearNonDefaultToEmptyNoArena();
    }
  ...
  if (cached_has_bits & 0x00000f00u) {
    ::memset(&number_past_frames_exclude_current_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&latency_second_) -
        reinterpret_cast<char*>(&number_past_frames_exclude_current_)) + sizeof(latency_second_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 112)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedEnumParser(mutable_object_types(), ptr, ctx, ::waymo::open_dataset::Label_Type_IsValid, &_internal_metadata_, 14);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 125)) {
          _Internal::set_has_latency_second(&has_bits);
      ...
      case 16:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 130)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_docker_image_source(), ptr, ctx, "waymo.open_dataset.Submission.docker_image_source");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 15: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (125 & 0xFF)) {
          _Internal::set_has_latency_second(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
      ...
      case 16: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (130 & 0xFF)) {
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadString(
                input, this->mutable_docker_image_source()));
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
            this->docker_image_source().data(), static_cast<int>(this->docker_image_source().length()),
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::PARSE,
            "waymo.open_dataset.Submission.docker_image_source");
        } else {
          goto handle_unusual;
        }
        break;
...
void Submission::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000040u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessageMaybeToArray(
      11, _Internal::inference_results(this), output);
  }
  ...
  if (cached_has_bits & 0x00000020u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      "waymo.open_dataset.Submission.docker_image_source");
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteStringMaybeAliased(
      16, this->docker_image_source(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* Submission::InternalSerializeWithCachedSizesToArray(
  ...
  if (cached_has_bits & 0x00000040u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        11, _Internal::inference_results(this), target);
  }
  ...
  if (cached_has_bits & 0x00000020u) {
    ...
    target =
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteStringToArray(
        16, this->docker_image_source(), target);
  }
...
void Submission::InternalSwap(Submission* other) {
  ...
  account_name_.Swap(&other->account_name_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  docker_image_source_.Swap(&other->docker_image_source_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
