...
class Submission :
 ...
 public:
  ...
  enum : int {
    ...
    kObjectTypesFieldNumber = 14,
    kUniqueMethodNameFieldNumber = 2,
    kAffiliationFieldNumber = 4,
    kDescriptionFieldNumber = 5,
    kMethodLinkFieldNumber = 6,
    kAccountNameFieldNumber = 13,
    kDockerImageSourceFieldNumber = 16,
    kInferenceResultsFieldNumber = 11,
    kTaskFieldNumber = 1,
    kNumberPastFramesExcludeCurrentFieldNumber = 9,
    kNumberFutureFramesExcludeCurrentFieldNumber = 10,
    kSensorTypeFieldNumber = 12,
    kLatencySecondFieldNumber = 15,
  };
  ...
  bool has_docker_image_source() const;
  void clear_docker_image_source();
  const std::string& docker_image_source() const;
  void set_docker_image_source(const std::string& value);
  void set_docker_image_source(std::string&& value);
  void set_docker_image_source(const char* value);
  void set_docker_image_source(const char* value, size_t size);
  std::string* mutable_docker_image_source();
  std::string* release_docker_image_source();
  void set_allocated_docker_image_source(std::string* docker_image_source);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr docker_image_source_;
...
// optional string docker_image_source = 16;
inline bool Submission::has_docker_image_source() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void Submission::clear_docker_image_source() {
  docker_image_source_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000020u;
}
inline const std::string& Submission::docker_image_source() const {
  // @@protoc_insertion_point(field_get:waymo.open_dataset.Submission.docker_image_source)
  return docker_image_source_.GetNoArena();
}
inline void Submission::set_docker_image_source(const std::string& value) {
  _has_bits_[0] |= 0x00000020u;
  docker_image_source_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:waymo.open_dataset.Submission.docker_image_source)
}
inline void Submission::set_docker_image_source(std::string&& value) {
  _has_bits_[0] |= 0x00000020u;
  docker_image_source_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:waymo.open_dataset.Submission.docker_image_source)
}
inline void Submission::set_docker_image_source(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000020u;
  docker_image_source_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:waymo.open_dataset.Submission.docker_image_source)
}
inline void Submission::set_docker_image_source(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000020u;
  docker_image_source_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:waymo.open_dataset.Submission.docker_image_source)
}
inline std::string* Submission::mutable_docker_image_source() {
  _has_bits_[0] |= 0x00000020u;
  // @@protoc_insertion_point(field_mutable:waymo.open_dataset.Submission.docker_image_source)
  return docker_image_source_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Submission::release_docker_image_source() {
  // @@protoc_insertion_point(field_release:waymo.open_dataset.Submission.docker_image_source)
  if (!has_docker_image_source()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000020u;
  return docker_image_source_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Submission::set_allocated_docker_image_source(std::string* docker_image_source) {
  if (docker_image_source != nullptr) {
    _has_bits_[0] |= 0x00000020u;
  } else {
    _has_bits_[0] &= ~0x00000020u;
  }
  docker_image_source_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), docker_image_source);
  // @@protoc_insertion_point(field_set_allocated:waymo.open_dataset.Submission.docker_image_source)
}
