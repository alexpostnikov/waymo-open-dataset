...
extern PROTOBUF_INTERNAL_EXPORT_waymo_5fopen_5fdataset_2flabel_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Label_Association_waymo_5fopen_5fdataset_2flabel_2eproto;
...
extern PROTOBUF_INTERNAL_EXPORT_waymo_5fopen_5fdataset_2fprotos_2fkeypoint_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_CameraKeypoints_waymo_5fopen_5fdataset_2fprotos_2fkeypoint_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_waymo_5fopen_5fdataset_2fprotos_2fkeypoint_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_LaserKeypoints_waymo_5fopen_5fdataset_2fprotos_2fkeypoint_2eproto;
namespace waymo {
...
class Label_AssociationDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<Label_Association> _instance;
...
class LabelDefaultTypeInternal {
 public:
  ...
  const ::waymo::open_dataset::keypoints::LaserKeypoints* laser_keypoints_;
  const ::waymo::open_dataset::keypoints::CameraKeypoints* camera_keypoints_;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<5> scc_info_Label_waymo_5fopen_5fdataset_2flabel_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 5, InitDefaultsscc_info_Label_waymo_5fopen_5fdataset_2flabel_2eproto}, {
      ...
      &scc_info_Label_Association_waymo_5fopen_5fdataset_2flabel_2eproto.base,}};

static void InitDefaultsscc_info_Label_Association_waymo_5fopen_5fdataset_2flabel_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::waymo::open_dataset::_Label_Association_default_instance_;
    new (ptr) ::waymo::open_dataset::Label_Association();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::waymo::open_dataset::Label_Association::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Label_Association_waymo_5fopen_5fdataset_2flabel_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsscc_info_Label_Association_waymo_5fopen_5fdataset_2flabel_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_waymo_5fopen_5fdataset_2flabel_2eproto[5];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_waymo_5fopen_5fdataset_2flabel_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  2,
  3,
  PROTOBUF_FIELD_OFFSET(::waymo::open_dataset::Label_Association, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::waymo::open_dataset::Label_Association, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::waymo::open_dataset::Label_Association, laser_object_id_),
  0,
  ...
  ~0u,  // no _extensions_
  PROTOBUF_FIELD_OFFSET(::waymo::open_dataset::Label, _oneof_case_[0]),
  ~0u,  // no _weak_field_map_
  ...
  offsetof(::waymo::open_dataset::LabelDefaultTypeInternal, laser_keypoints_),
  offsetof(::waymo::open_dataset::LabelDefaultTypeInternal, camera_keypoints_),
  PROTOBUF_FIELD_OFFSET(::waymo::open_dataset::Label, association_),
  PROTOBUF_FIELD_OFFSET(::waymo::open_dataset::Label, keypoints_oneof_),
  1,
  2,
  4,
  0,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 32, 38, sizeof(::waymo::open_dataset::Label_Association)},
  { 39, 55, sizeof(::waymo::open_dataset::Label)},
  { 65, 73, sizeof(::waymo::open_dataset::Polygon2dProto)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::waymo::open_dataset::_Label_Association_default_instance_),
...
const char descriptor_table_protodef_waymo_5fopen_5fdataset_2flabel_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\036waymo_open_dataset/label.proto\022\022waymo."
  "open_dataset\032(waymo_open_dataset/protos/"
  "keypoint.proto\"\232\010\n\005Label\022*\n\003box\030\001 \001(\0132\035."
  "waymo.open_dataset.Label.Box\0224\n\010metadata"
  "\030\002 \001(\0132\".waymo.open_dataset.Label.Metada"
  "ta\022,\n\004type\030\003 \001(\0162\036.waymo.open_dataset.La"
  "bel.Type\022\n\n\002id\030\004 \001(\t\022M\n\032detection_diffic"
  "ulty_level\030\005 \001(\0162).waymo.open_dataset.La"
  "bel.DifficultyLevel\022L\n\031tracking_difficul"
  "ty_level\030\006 \001(\0162).waymo.open_dataset.Labe"
  "l.DifficultyLevel\022\037\n\027num_lidar_points_in"
  "_box\030\007 \001(\005\022G\n\017laser_keypoints\030\010 \001(\0132,.wa"
  "ymo.open_dataset.keypoints.LaserKeypoint"
  "sH\000\022I\n\020camera_keypoints\030\t \001(\0132-.waymo.op"
  "en_dataset.keypoints.CameraKeypointsH\000\022:"
  "\n\013association\030\n \001(\0132%.waymo.open_dataset"
  ".Label.Association\032\277\001\n\003Box\022\020\n\010center_x\030\001"
  " \001(\001\022\020\n\010center_y\030\002 \001(\001\022\020\n\010center_z\030\003 \001(\001"
...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_waymo_5fopen_5fdataset_2flabel_2eproto_deps[1] = {
  &::descriptor_table_waymo_5fopen_5fdataset_2fprotos_2fkeypoint_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_waymo_5fopen_5fdataset_2flabel_2eproto_sccs[5] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_waymo_5fopen_5fdataset_2flabel_2eproto = {
  &descriptor_table_waymo_5fopen_5fdataset_2flabel_2eproto_initialized, descriptor_table_protodef_waymo_5fopen_5fdataset_2flabel_2eproto, "waymo_open_dataset/label.proto", 1199,
  &descriptor_table_waymo_5fopen_5fdataset_2flabel_2eproto_once, descriptor_table_waymo_5fopen_5fdataset_2flabel_2eproto_sccs, descriptor_table_waymo_5fopen_5fdataset_2flabel_2eproto_deps, 5, 1,
  schemas, file_default_instances, TableStruct_waymo_5fopen_5fdataset_2flabel_2eproto::offsets,
  file_level_metadata_waymo_5fopen_5fdataset_2flabel_2eproto, 5, file_level_enum_descriptors_waymo_5fopen_5fdataset_2flabel_2eproto, file_level_service_descriptors_waymo_5fopen_5fdataset_2flabel_2eproto,
};
...
class Label_Metadata::_Internal {
 public:
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 9)) {
          _Internal::set_has_speed_x(&has_bits);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 17)) {
          _Internal::set_has_speed_y(&has_bits);
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (9 & 0xFF)) {
          _Internal::set_has_speed_x(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   double, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_DOUBLE>(
                 input, &speed_x_)));
        } else {
      ...
      case 2: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (17 & 0xFF)) {
          _Internal::set_has_speed_y(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
                   double, ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_DOUBLE>(
                 input, &speed_y_)));
        } else {
...
void Label_Association::InitAsDefaultInstance() {
}
class Label_Association::_Internal {
 public:
  using HasBits = decltype(std::declval<Label_Association>()._has_bits_);
  static void set_has_laser_object_id(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
};
...
Label_Association::Label_Association()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:waymo.open_dataset.Label.Association)
}
Label_Association::Label_Association(const Label_Association& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
      _has_bits_(from._has_bits_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  laser_object_id_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (from.has_laser_object_id()) {
    laser_object_id_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.laser_object_id_);
  }
  // @@protoc_insertion_point(copy_constructor:waymo.open_dataset.Label.Association)
}

void Label_Association::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Label_Association_waymo_5fopen_5fdataset_2flabel_2eproto.base);
  laser_object_id_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

Label_Association::~Label_Association() {
  // @@protoc_insertion_point(destructor:waymo.open_dataset.Label.Association)
  SharedDtor();
}

void Label_Association::SharedDtor() {
  laser_object_id_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void Label_Association::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const Label_Association& Label_Association::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Label_Association_waymo_5fopen_5fdataset_2flabel_2eproto.base);
  return *internal_default_instance();
}


void Label_Association::Clear() {
// @@protoc_insertion_point(message_clear_start:waymo.open_dataset.Label.Association)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  cached_has_bits = _has_bits_[0];
  if (cached_has_bits & 0x00000001u) {
    laser_object_id_.ClearNonDefaultToEmptyNoArena();
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* Label_Association::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_laser_object_id(), ptr, ctx, "waymo.open_dataset.Label.Association.laser_object_id");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
#else  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
bool Label_Association::MergePartialFromCodedStream(
    ::PROTOBUF_NAMESPACE_ID::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:waymo.open_dataset.Label.Association)
  for (;;) {
    ::std::pair<::PROTOBUF_NAMESPACE_ID::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
      ...
      case 1: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (10 & 0xFF)) {
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadString(
                input, this->mutable_laser_object_id()));
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
            this->laser_object_id().data(), static_cast<int>(this->laser_object_id().length()),
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::PARSE,
            "waymo.open_dataset.Label.Association.laser_object_id");
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:waymo.open_dataset.Label.Association)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:waymo.open_dataset.Label.Association)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void Label_Association::SerializeWithCachedSizes(
    ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:waymo.open_dataset.Label.Association)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:waymo.open_dataset.Label.Association)
}

::PROTOBUF_NAMESPACE_ID::uint8* Label_Association::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:waymo.open_dataset.Label.Association)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:waymo.open_dataset.Label.Association)
  return target;
}

size_t Label_Association::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:waymo.open_dataset.Label.Association)
  size_t total_size = 0;
...
void Label_Association::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:waymo.open_dataset.Label.Association)
  GOOGLE_DCHECK_NE(&from, this);
  const Label_Association* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Label_Association>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:waymo.open_dataset.Label.Association)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:waymo.open_dataset.Label.Association)
    MergeFrom(*source);
  }
}

void Label_Association::MergeFrom(const Label_Association& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:waymo.open_dataset.Label.Association)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void Label_Association::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:waymo.open_dataset.Label.Association)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void Label_Association::CopyFrom(const Label_Association& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:waymo.open_dataset.Label.Association)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Label_Association::IsInitialized() const {
  return true;
}

void Label_Association::InternalSwap(Label_Association* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
  laser_object_id_.Swap(&other->laser_object_id_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
}

::PROTOBUF_NAMESPACE_ID::Metadata Label_Association::GetMetadata() const {
  return GetMetadataStatic();
}
...
void Label::InitAsDefaultInstance() {
  ...
  ::waymo::open_dataset::_Label_default_instance_.laser_keypoints_ = const_cast< ::waymo::open_dataset::keypoints::LaserKeypoints*>(
      ::waymo::open_dataset::keypoints::LaserKeypoints::internal_default_instance());
  ::waymo::open_dataset::_Label_default_instance_.camera_keypoints_ = const_cast< ::waymo::open_dataset::keypoints::CameraKeypoints*>(
      ::waymo::open_dataset::keypoints::CameraKeypoints::internal_default_instance());
  ::waymo::open_dataset::_Label_default_instance_._instance.get_mutable()->association_ = const_cast< ::waymo::open_dataset::Label_Association*>(
      ::waymo::open_dataset::Label_Association::internal_default_instance());
}
class Label::_Internal {
 public:
  ...
  static const ::waymo::open_dataset::keypoints::LaserKeypoints& laser_keypoints(const Label* msg);
  static const ::waymo::open_dataset::keypoints::CameraKeypoints& camera_keypoints(const Label* msg);
  static const ::waymo::open_dataset::Label_Association& association(const Label* msg);
...
Label::_Internal::box(const Label* msg) {
  return *msg->box_;
}
const ::waymo::open_dataset::Label_Metadata&
Label::_Internal::metadata(const Label* msg) {
  return *msg->metadata_;
}
const ::waymo::open_dataset::keypoints::LaserKeypoints&
Label::_Internal::laser_keypoints(const Label* msg) {
  return *msg->keypoints_oneof_.laser_keypoints_;
}
const ::waymo::open_dataset::keypoints::CameraKeypoints&
Label::_Internal::camera_keypoints(const Label* msg) {
  return *msg->keypoints_oneof_.camera_keypoints_;
}
const ::waymo::open_dataset::Label_Association&
Label::_Internal::association(const Label* msg) {
  return *msg->association_;
}
void Label::set_allocated_laser_keypoints(::waymo::open_dataset::keypoints::LaserKeypoints* laser_keypoints) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  clear_keypoints_oneof();
  if (laser_keypoints) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      laser_keypoints = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, laser_keypoints, submessage_arena);
    }
    set_has_laser_keypoints();
    keypoints_oneof_.laser_keypoints_ = laser_keypoints;
  }
  // @@protoc_insertion_point(field_set_allocated:waymo.open_dataset.Label.laser_keypoints)
}
void Label::clear_laser_keypoints() {
  if (has_laser_keypoints()) {
    delete keypoints_oneof_.laser_keypoints_;
    clear_has_keypoints_oneof();
  }
}
void Label::set_allocated_camera_keypoints(::waymo::open_dataset::keypoints::CameraKeypoints* camera_keypoints) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  clear_keypoints_oneof();
  if (camera_keypoints) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      camera_keypoints = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, camera_keypoints, submessage_arena);
    }
    set_has_camera_keypoints();
    keypoints_oneof_.camera_keypoints_ = camera_keypoints;
  }
  // @@protoc_insertion_point(field_set_allocated:waymo.open_dataset.Label.camera_keypoints)
}
void Label::clear_camera_keypoints() {
  if (has_camera_keypoints()) {
    delete keypoints_oneof_.camera_keypoints_;
    clear_has_keypoints_oneof();
  }
}
Label::Label()
...
Label::Label(const Label& from)
  ...
  if (from.has_association()) {
    association_ = new ::waymo::open_dataset::Label_Association(*from.association_);
  } else {
  ...
  clear_has_keypoints_oneof();
  switch (from.keypoints_oneof_case()) {
    case kLaserKeypoints: {
      mutable_laser_keypoints()->::waymo::open_dataset::keypoints::LaserKeypoints::MergeFrom(from.laser_keypoints());
      break;
    }
    case kCameraKeypoints: {
      mutable_camera_keypoints()->::waymo::open_dataset::keypoints::CameraKeypoints::MergeFrom(from.camera_keypoints());
      break;
    }
    case KEYPOINTS_ONEOF_NOT_SET: {
      break;
    }
  }
...
void Label::clear_keypoints_oneof() {
// @@protoc_insertion_point(one_of_clear_start:waymo.open_dataset.Label)
  switch (keypoints_oneof_case()) {
    case kLaserKeypoints: {
      delete keypoints_oneof_.laser_keypoints_;
      break;
    }
...
// @@protoc_insertion_point(message_clear_start:waymo.open_dataset.Label)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      GOOGLE_DCHECK(association_ != nullptr);
      association_->Clear();
    }
  }
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 56)) {
          _Internal::set_has_num_lidar_points_in_box(&has_bits);
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 66)) {
          ptr = ctx->ParseMessage(mutable_laser_keypoints(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 74)) {
          ptr = ctx->ParseMessage(mutable_camera_keypoints(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 82)) {
          ptr = ctx->ParseMessage(mutable_association(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (56 & 0xFF)) {
          _Internal::set_has_num_lidar_points_in_box(&_has_bits_);
          DO_((::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadPrimitive<
      ...
      case 9: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (74 & 0xFF)) {
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadMessage(
               input, mutable_camera_keypoints()));
        } else {
          goto handle_unusual;
        }
        break;
...
void Label::SerializeWithCachedSizes(
  ...
  switch (keypoints_oneof_case()) {
    case kLaserKeypoints:
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessageMaybeToArray(
        8, _Internal::laser_keypoints(this), output);
      break;
    case kCameraKeypoints:
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessageMaybeToArray(
        9, _Internal::camera_keypoints(this), output);
      break;
    default: ;
  }
  // optional .waymo.open_dataset.Label.Association association = 10;
  if (cached_has_bits & 0x00000008u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteMessageMaybeToArray(
      10, _Internal::association(this), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* Label::InternalSerializeWithCachedSizesToArray(
  ...
  switch (keypoints_oneof_case()) {
    case kLaserKeypoints:
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessageToArray(
          8, _Internal::laser_keypoints(this), target);
      break;
    case kCameraKeypoints:
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessageToArray(
          9, _Internal::camera_keypoints(this), target);
      break;
    default: ;
  }
  // optional .waymo.open_dataset.Label.Association association = 10;
  if (cached_has_bits & 0x00000008u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        10, _Internal::association(this), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:waymo.open_dataset.Label)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      mutable_association()->::waymo::open_dataset::Label_Association::MergeFrom(from.association());
    }
    if (cached_has_bits & 0x00000010u) {
      type_ = from.type_;
    }
...
void Label::InternalSwap(Label* other) {
  ...
  swap(keypoints_oneof_, other->keypoints_oneof_);
...
class Polygon2dProto::_Internal {
 public:
...
template<> PROTOBUF_NOINLINE ::waymo::open_dataset::Label_Association* Arena::CreateMaybeMessage< ::waymo::open_dataset::Label_Association >(Arena* arena) {
  return Arena::CreateInternal< ::waymo::open_dataset::Label_Association >(arena);
}
